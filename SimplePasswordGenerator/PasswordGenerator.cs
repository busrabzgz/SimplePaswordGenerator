...
namespace SimplePasswordGenerator
{
	public class PasswordGenerator
	{
        ...
        private const string LowercaseCharacters = "abcdefghijklmnoprstuvyzwxq";

        private const string UppercaseCharacters = "ABCDEFGHIJKLMNOPRSTUVYZXWQ";
        ...
        private void ShowErrorMessage(string? message=null)
        {
            ...
            {
                Console.WriteLine("BADDIRL.Gotch you!");
                return;
            }
        ...
        public string GetLatesGeneratedPassword() => _lastGeneratedPassword;
        public List<string> GetGeneratedPaawords() => _generatedPasswords;
        public void WriteLatestGeneratedPassword() => WriteFormattedPassword(_lastGeneratedPassword);
        public void WriteGeneratedPasswors() => _generatedPasswords.ForEach(WriteFormattedPassword);
